...
from GAN.GAN_backend.config import model_name
#############################################################################
...
def define_generator(image_shape=(256,256,3)):
	...
	# output
	g = Conv2DTranspose(image_shape[2], (4,4), strides=(2,2), padding='same', kernel_initializer=init)(d7) #GAN.GAN_backend
...
def summarize_performance(step, g_model, dataset, n_samples=3):
    ...
    # save plot to file
    filename2 = model_name + "_" +str(step+1)+".h5"
